...
void Foam::maxwellSlipUFvPatchVectorField::write(Ostream& os) const
{
    ...
    //Uwall_.writeEntry(os, "Uwall"); //scambiato ordine input
    ...
    //refValue().writeEntry(os, "refValue"); //scambiato ordine input
    //valueFraction().writeEntry(os, "valueFraction");//scambiato ordine input

    //writeEntry(os, "value"); //scambiato ordine input
}
