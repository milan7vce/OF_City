...
#SBATCH --job-name=snapcluster1                # Job name
...
#SBATCH --output=snapcluster1.out        # Standard output and error log [%j is replaced with the jobid]
#SBATCH --error=snapcluster1.error
...
date > dateLog
mpirun -np  384 snappyHexMesh -parallel  1>log_snappyHexMesh>&1
